...
class App extends React.Component {
  constructor(props) {
    ...
    if (typeof web3 !== 'undefined') {
      ...
      this.web3Provider = new web3.providers.HttpProvider('http://localhost:3001');
    ...
    // this.contracts.setProvider(this.web3);
  }
    ...
    this.web3.eth.getAccounts((error, accounts) => {
      ...
      this.contracts
        ...
        .then(instance => {
          ...
          return instance.buyBetterMarket(id, this.web3.toHex(nameUtf8Encoded), age, {
            from: account,
            value: price
          });
        })
